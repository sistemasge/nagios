...
#echo $EXPR_WARN
MSG1="$(df -Pkhl -x squashfs | egrep "($EXPR_WARN)%")" #espacio libre
MSGI1="$(df -Pkhil -x squashfs | egrep "($EXPR_WARN)%")" #inodos libres (opción -i)
...
#echo $EXPR_CRIT
MSG2="$(df -Pkhl -x squashfs | egrep "($EXPR_CRIT)%")" #espacio libre
MSGI2="$(df -Pkhil -x squashfs | egrep "($EXPR_CRIT)%")" #inodos libres (opción -i)
